...
REQUIRED_TEXT = (
    ...
    "source_obligations_total == source_obligations_planned + source_residual + source_proven_not_executed",
    "source_obligations_planned == source_nodes_planned",
    "quality_from_basis",
    "source -> exact",
    "derived -> derived",
    "measured | calibrated -> calibrated",
    "modeled | assumed -> estimated",
    "ObservationRef",
    "calibration_train_manifest_digest",
    "record.observation_ref.split == calibration_train",
    "holdout_manifest_digest and conformance_fixture_manifest_digest are offline-only",
    "MeasurementKey",
    ...
    "MemoryNumericPolicySnapshot",
    "MemoryNumericRangeWitness",
    "unbounded_integer_memory_preflight",
    "InputBlocker(BLK-NUMERIC-RANGE, memory)",
    ...
    "ConformanceDeploymentProfile := local_integrity | hardened_attestation",
...
MODULE_CONTRACT_REQUIRED_TEXT = {
    ...
    "memory-backend": (
        ...
        "MemoryNumericRangeWitness:",
        "unbounded_integer_memory_preflight(",
        "otherwise InputBlocker(BLK-NUMERIC-RANGE, memory)",
    ...
    "conformance": (
        ...
        "local_integrity is the default conformance deployment profile",
        "hardened_attestation is optional",
        "LocalIntegrityInvocationAuthority:",
        "LocalIntegrityObservedOutput:",
        "execution_records: OrderedMap<FixtureRef, LocalIntegrityExecutionRecord>",
        "observed_output: LocalIntegrityObservedOutput",
        "run_local_integrity_conformance( authority: LocalIntegrityInvocationAuthority ) -> LocalIntegrityRunResult",
        "local_integrity threat model assumes the CI/verifier process and artifact store are trusted",
        "hardened_attestation is only required when runner forgery or report replay is in scope",
        "TraceFixture:",
        "FixtureSet:",
        "ConformanceFinding:",
        "ApprovedDigestSet:",
