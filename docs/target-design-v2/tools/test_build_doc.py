...
EXPECTED_DIAGRAM_TEXT = {
    ...
    "end-to-end-sequence": (
        "build_request_snapshot",
        "RuntimeEventPlan",
        "BackendSealArtifact.result",
    ),
    "evidence-coverage-class": ("BackendResult", "SemanticValue", "EvidenceTag", "Coverage"),
    ...
    "code-ir-class": ("RankCodeIRBuildInput", "TensorStorageRelation", "SourceObligation"),
    "value-storage-identity": ("ValuePrototypeRef", "TensorInstanceId", "SimulationInitialState"),
    "op-semantic-class": ("StructureRegistrySnapshot", "OpSemantic", "EffectSummary"),
    ...
    "runtime-events-class": ("RuntimeEventPlan", "ResolvedEventSemantic", "AutogradLink"),
    "runtime-event-expansion": ("AutogradLink", "P2PIntent", "CollectiveIntent"),
    "placement-binding-class": ("ExecutionDeployment", "KernelVariantBinding", "RouteBinding"),
    "core-dual-projection": ("KernelVariantBinding", "ProjectionBundleAuthority", "NotRequested"),
    "simulation-plan-class": (
        "ProjectionBundleAuthority",
        "ProjectionCandidate",
        "MemoryEventView",
        "TimeEventView",
    ),
    "memory-backend-class": ("MemoryEventView", "WorkspaceBinding", "MemoryExecutionWitness"),
    ...
    "memory-replay-flowchart": ("INITIAL_STATE", "live_allocated", "RankMemoryEstimate"),
    "time-backend-class": ("TimeEventView", "BoundCommunicationCommon", "StepTimeEstimate"),
    "time-progress-des": ("ComputeMeasurementRecord", "CommunicationModelSnapshot", "No-contention DES"),
    "time-backend-sequence": ("TimeEventView", "bound_duration_ns", "checked_add"),
    "time-des-flowchart": ("progress_nodes", "checked_add", "StepTimeEstimate"),
    "result-sealing-class": (
        "BackendResultSourceAuthority",
        "EstimateCandidate",
        "BackendSealArtifact",
    ),
    "comparison-class": ("ComparisonArmAuthority", "ComparisonBasisPair", "ComparisonSealArtifact"),
    "gate-system-class": ("GateSpecificationSet", "GateManifestEntry", "GateExecutionLedger"),
...
class BuildDocArtifactTest(unittest.TestCase):
    ...
    def test_authority_template_declares_exactly_the_approved_diagrams(self) -> None:
